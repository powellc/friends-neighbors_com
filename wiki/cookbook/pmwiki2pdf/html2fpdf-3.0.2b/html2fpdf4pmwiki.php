...
function PutHREF($url) { // Created by the_CName; return the URL.
	$xploz = explode('?', $url);
	$this->url = $xploz[0];
}
...
//! @desc The footer is printed in every page!
    ...
    // modified by the_CName
    $this->SetTextColor(0,0,180);
	$this->Cell(0,10,'Created with HTML2FPDF / FPDF',0,0,'R',0,'http://html2fpdf.sourceforge.net/');
	$this->Ln(3);
	$this->Cell(0,10,$this->title,0,0,'L',0,$this->url);
	$this->Cell(0,10,'Hacked for PmWiki Product',0,0,'R',0,'http://pmwiki.com/wiki/Profiles/TheCName');
			  ...
			  case 'FONT-SIZE': //Does not support: smaller, larger
                 ...
                 case 'X-SMALL': $this->SetFontSize( (0.77) * 11);
  			         ...
  			         case 'XX-LARGE': 
  			         	...
  			         	$this->lineheight *= 2; // <-- new line to correct lineheigt
			               break;
              }
            }
			   	  break;
